    ...
    return (
      <View style={styles.movie}>
        <Image style={styles.backdrop}
               source={{uri: "http://image.tmdb.org/t/p/w500" + this.props.display.backdrop_path}} />
        <View style={styles.posterContainer}>
          <Image style={styles.poster}
                 source={{uri: "http://image.tmdb.org/t/p/w500" + this.props.display.poster_path}} />
        </View>
        <View style={styles.titleAndVotes}>
          <Text style={styles.title}>{this.props.display.title}</Text>
          <Text style={styles.votes}>{this.props.display.vote_average}</Text>
        </View>
        <Text style={styles.overview}>{this.props.display.overview}
        </Text>
      </View>
    );
  }
